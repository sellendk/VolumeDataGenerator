...
public:
	...
	*/
	double userDef(const Vec3<int> &cords, const Vec3<double> &mag, const Vec3<int> &freq, const Vec3<int> &res, const std::string &str);
	...
	* @return scalar The scalar data calculated
	*/
	double rect(const Vec3<int> &cords, const Vec3<double> &mag, const Vec3<int> &freq, const Vec3<int> &res);
	...
	* @return scalar The scalar data calculated
	*/
	double triangle(const Vec3<int> &cords, const Vec3<double> &mag, const Vec3<int> &freq, const Vec3<int> &res);
	...
	* @return scalar The scalar data calculated
	*/
	double sine(const Vec3<int> &cords, const Vec3<double> &mag, const Vec3<int> &freq, const Vec3<int> &res);
	...
	* @return scalar The scalar data calculated
	*/
	double cosine(const Vec3<int> &cords, const Vec3<double> &mag, const Vec3<int> &freq, const Vec3<int> &res);
